...
/**
 * Injects the appropriate icon into the button and animates it with a bounce+rotate.
 * @param {HTMLElement} element - The button or container element.
 * @param {"list"|"grid"} type - Icon type to display.
 */
